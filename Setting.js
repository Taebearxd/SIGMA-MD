...
global.owner = process.env.OWNER_NUMBER  || '917439317360' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Taebearxd:<jimin07>@clusterii.bdkf1w1.mongodb.net/" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "918697988808" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"⎯⎯    𝐀𝑚𝐨𝐮𝑟.    𔗫",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://chat.whatsapp.com/EZjCgLTJfRd8LHOyVC163u' ; 
...
module.exports = {
  ...
  ownername:  process.env.OWNER_NAME  || `𝚫𝐃𝐑𝐈𝚵𝚴`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝆺𝅥 𝇁 ֹ 𝄄 س ꓹ 𝚫𝐃𝐑𝐈𝚵𝚴 𓂃🧣',      // ADD YOUR STICKER AUTHOR NAME
